...
<style>
        ...
        * {
        ...
        .navbar {
            display: flex;
            justify-content: flex-end; /* MODIFIED: Pushes all content to the right */
            align-items: center;
            padding: 15px 20px;
            background-color: var(--white);
        ...
        .content-section {
            display: block; /* MODIFIED: Always show content section */
            width: 100%;
        }
        ...
        .chart-placeholder {
            ...
            border-radius: 4px;
            display: flex;
            align-items: flex-end; /* MODIFIED: Aligns charts to the bottom */
            justify-content: center;
            color: var(--text-light);
            font-size: 1.1rem;
            position: relative;
        ...
        /* Chart Styles - IMPROVED FOR BETTER ALIGNMENT */
        .chart {
            width: 100%;
            height: 100%;
            display: flex;
        ...
        /* Pie Chart - IMPROVED FOR BETTER ALIGNMENT */
        .pie-chart-container {
            display: flex;
            flex-direction: column;
            align-items: center;
        ...
        <div class="content">
            ...
            <div id="analytics-content" class="content-section">
                ...
                <div class="table-container mb-20">
                    <div
                        style="padding: 15px; display: grid; grid-template-columns: 1fr; gap: 15px;">
                        <div class="form-group">
                            <label class="form-label">Date Range</label>
                            <select class="form-control" id="dateRange">
                                <option value="7">Last 7 Days</option>
                                <option value="30" selected>Last 30
                                    Days</option>
                    ...
                    <div class="apply-filters">
                        <button class="btn btn-primary"
                            id="applyAnalyticsFilters">Apply
                            Filters</button>
                    </div>
                </div>
                    ...
                    {{-- <div class="chart-header">
                        ...
                        <div class="chart-actions">
                            <button class="btn btn-secondary btn-sm"
                                data-chart="user-daily">Daily</button>
                            <button class="btn btn-secondary btn-sm"
                                data-chart="user-weekly">Weekly</button>
                            ...
                            <div class="chart-bars">
                                ...
                                <div class="chart-bar-container">
                                    <div class="chart-bar"
                                        style="height: 45%;">
                                        <span
                                            class="chart-bar-value">112</span>
                                    </div>
                                ...
                                <div class="chart-bar-container">
                                    <div class="chart-bar"
                                        style="height: 60%;">
                                        <span
                                            class="chart-bar-value">150</span>
                                    </div>
                                ...
                                <div class="chart-bar-container">
                                    <div class="chart-bar"
                                        style="height: 75%;">
                                        <span
                                            class="chart-bar-value">187</span>
                                    </div>
                                ...
                                <div class="chart-bar-container">
                                    <div class="chart-bar"
                                        style="height: 90%;">
                                        <span
                                            class="chart-bar-value">225</span>
                                    </div>
                                ...
                                <div class="chart-bar-container">
                                    <div class="chart-bar"
                                        style="height: 100%;">
                                        <span
                                            class="chart-bar-value">247</span>
                                    </div>
                                    <div class="chart-bar-label">Jun</div>
                                </div>
                            </div>
                            <div class="chart-x-axis">
                                {{-- <span>Monthly User Growth (Last 6
                                    Months)</span> --}}
                            </div>
                        </div>
                    </div>
                ...
                <!-- Review Activity Chart - IMPROVED ALIGNMENT -->
                <div class="chart-container">
                    <div class="chart-header">
                ...
                <!-- Business Metrics - IMPROVED ALIGNMENT -->
                <div class="chart-container">
                    <div class="chart-header">
