    ...
    <form id="registrationForm" class="space-y-4">
        ...
        <div>
            ...
            <select id="industry" name="industry" 
                ...
                required>
                <option value="" disabled selected><?php echo e(__('common.Select category')); ?></option>
        ...
        <div>
            ...
            <select id="location" name="location" 
                class="w-full bg-white border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-purple-primary focus:border-transparent transition appearance-none text-gray-700"
                required>
                <option value="" disabled selected><?php echo e(__('common.Select location')); ?></option>
...
</div><?php /**PATH C:\KajalProjects\ReviewManagement\resources\views/business/auth/registration.blade.php ENDPATH**/ ?>